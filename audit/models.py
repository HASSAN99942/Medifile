...
class AuditLog(models.Model):
    ...
    class Action(models.TextChoices):
        ...
        DEMANDE_ACCES = "DEMANDE_ACCES", _("Demande d'accès envoyée")
        APPROBATION_ACCES = "APPROBATION_ACCES", _("Demande d'accès approuvée")
        REFUS_ACCES = "REFUS_ACCES", _("Demande d'accès refusée")
